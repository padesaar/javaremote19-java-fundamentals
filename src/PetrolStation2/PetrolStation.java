...
public class PetrolStation {
    ...
    //if you use these 3 words together, its constant variable, and you can use capital letters
    ...
    public static void main(String[] args) {
        ...
        System.out.println("*************************");
        System.out.println("Today's petrol price is:" + PETROL_PRICE_PER_LITRE + CURRENCY);
    ...
    private static double getMoney() {
        return new Random().nextDouble(1 - 2000) + 1;
    }
}